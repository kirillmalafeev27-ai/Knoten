...
For speech, the server proxies ElevenLabs through `/api/tts`, so the browser never sees your ElevenLabs secret. The default voice settings follow ElevenLabs' own guidance for natural speech: stability around `0.5`, similarity around `0.75`, style `0`, and speed `1.0`.
