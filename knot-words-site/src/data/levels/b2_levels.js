...
export const B2_LEVELS = [
  createLevel({
    ...
    sentences: [
      ...
      {
        color: COL.B,
        tokens: ["Wenn sie", "mutiger wäre", "würde sie", "sofort", "ihr Projekt", "starten"],
      ...
      {
        color: COL.G,
        tokens: ["Wenn wir", "früher gingen", "könnten wir", "heute", "den Zug", "erreichen"],
      ...
      {
        color: COL.O,
        tokens: ["Wenn er", "ruhiger wäre", "würde er", "im Gespräch", "klarer", "wirken"],
      ...
      {
        color: COL.Y,
        tokens: ["Wenn du", "genauer liest", "würdest du", "Details", "schneller", "finden"],
      ...
      {
        color: COL.R,
        tokens: ["Wenn ihr", "bleiben könntet", "würdet ihr", "das Konzert", "bis zuletzt", "hören"],
  ...
  createLevel({
    ...
    sentences: [
      {
        color: COL.B,
        tokens: ["Obwohl die", "Aufgabe komplex", "wirkt", "finden wir", "einen guten", "Einstieg"],
      ...
      {
        color: COL.G,
        tokens: ["Sobald die", "Daten klar", "sind", "kann das", "Team besser", "entscheiden"],
      ...
      {
        color: COL.P,
        tokens: ["Je offener", "wir sprechen", "desto leichter", "werden", "Konflikte", "lösbar"],
      ...
      {
        color: COL.O,
        tokens: ["Während viele", "nur planen", "setzt sie", "Ideen", "sauber", "um"],
      ...
      {
        color: COL.Y,
        tokens: ["Selbst wenn", "Kritik hart", "klingt", "nimmt er", "sie als", "Feedback"],
      ...
      {
        color: COL.R,
        tokens: ["Damit ein", "Team stabil", "bleibt", "braucht es", "klare", "Rollen"],
  ...
  createLevel({
    ...
    sentences: [
      {
        color: COL.G,
        tokens: ["Was ein", "Text verschweigt", "prägt oft", "unsere", "spätere", "Lesart"],
      ...
      {
        color: COL.B,
        tokens: ["Indem wir", "genauer zuhören", "erkennen wir", "feine", "Signale", "früher"],
      ...
      {
        color: COL.P,
        tokens: ["Kaum hatte", "der Vortrag", "begonnen", "wurden viele", "sofort", "neugierig"],
      ...
      {
        color: COL.O,
        tokens: ["Nicht weil", "es leicht", "wäre", "sondern weil", "es sinnvoll", "ist"],
      ...
      {
        color: COL.Y,
        tokens: ["Sogar wer", "langsam vorankommt", "kann ein", "Gefühl", "für Sprache", "entwickeln"],
      ...
      {
        color: COL.R,
        tokens: ["Erst wenn", "Zweifel sichtbar", "werden", "beginnt oft", "ein ehrliches", "Gespräch"],
