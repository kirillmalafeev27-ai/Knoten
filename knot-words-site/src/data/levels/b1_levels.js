...
export const B1_LEVELS = [
  ...
  createLevel({
    ...
    sentences: [
      {
        color: COL.B,
        tokens: ["Das Buch", "das ich", "gerade lese", "ist", "heute", "spannend"],
      ...
      {
        color: COL.G,
        tokens: ["Der Film", "den wir", "gestern sahen", "war", "sehr", "laut"],
